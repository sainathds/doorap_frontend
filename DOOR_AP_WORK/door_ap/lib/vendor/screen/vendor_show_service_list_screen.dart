                        ...
                        children: [
                          Container(
                            ...
                            ListView.builder(
                                ...
                                :
                            Center(
                              child: Text("Services are not found", style: TextStyle(fontSize: MyDimens.textSize14, color: MyColor.labelGrey, fontFamily: 'sf_pro_semibold'),),
                            ),
                          ),
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  InkWell(
                      onTap: (){
                        _getXController.hitDeleteServiceApi(_getXController.vendorServiceList[index].id);
                      },
