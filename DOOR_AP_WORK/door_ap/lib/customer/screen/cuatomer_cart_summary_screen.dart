...
class CustomerCartSummaryScreen extends StatefulWidget {
  ...
  CustomerCartSummaryScreen({Key? key, required this.vendorId, required this.categoryId, required this.customerAddressModel,}) : super(key: key);
...
class _CustomerCartSummaryScreenState extends State<CustomerCartSummaryScreen> {
  final CustomerCartSummaryController _getXController = Get.put(CustomerCartSummaryController());
  ...
  void initState() {
    ...
    // _getXController.cartData = widget.cartData;
    // _getXController.calculation = widget.calculation;
