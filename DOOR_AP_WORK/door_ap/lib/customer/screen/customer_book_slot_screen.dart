              ...
              children: [
                ...
                _getXController.data[_getXController.currentDateIndex].slotDetails!.isNotEmpty
                  ...
                  child: LayoutGrid(
                    ...
                    : Expanded(child: Center(child: Text('Vendor is available'))),
...
*/
  ...
  void compareTime() {
    ...
    DateTime time = DateTime.parse(_getXController.data[_getXController.currentDateIndex].date! + " " +_getXController.timeEditController.text.trim());
    ...
    if( time == fromTime || (time.isAfter(fromTime) && time.isBefore(toTime))){
