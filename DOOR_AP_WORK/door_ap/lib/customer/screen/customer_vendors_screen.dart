...
class _CustomerVendorsScreenState extends State<CustomerVendorsScreen> {
      ...
      child: Scaffold(
        body: Column(
          children: [
            ...
            vendorsListWidget()
                : Center(child: Text("no vendors are found",
  ...
  Widget headerWidget() {
    ...
    return Container(
      ...
      padding: const EdgeInsets.only(top: 15.0, left: 23.0, right: 23.0, bottom: 10),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(_getXController.serviceOrCategoryName,
                          ...
                          child: Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  _getXController.vendorsData![index].rating!,
                                  style: TextStyle(
                                    fontSize: MyDimens.textSize12,
                                    color: Colors.white,
