...
class VendorPaymentController extends GetxController{
  ...
  ///*
  ///
  /// get balance payment by calling show_vendor_totalearning/ Api
  ...
  ///*
  ///
  /// request to withdraw amount by calling withdraw_request/ Api
  ...
  ///*
  ///
  /// get received payment list by calling show_received_payment/ aPI
