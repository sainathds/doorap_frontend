...
class VendorCustomServiceController extends GetxController{
  ...
  ///
  ///
  /// create custom service by calling add_custom_service/ Api
  /// your service will create successfully
  /// but you will not see that service in Service List under category
  /// until Admin not take action on it i.e admin will add it to master
