class VendorOrderListResponse {
  int? _status;
  String? _msg;
  List<Payload>? _payload;

  VendorOrderListResponse({int? status, String? msg, List<Payload>? payload}) {
    if (status != null) {
      this._status = status;
    }
    if (msg != null) {
  ...
  VendorOrderListResponse.fromJson(Map<dynamic, dynamic> json) {
    _status = json['status'];
    _msg = json['msg'];
...
class Payload {
  ...
  set customerCity(String? customerCity) =>
