class VendorSaveProfileRequest {
  ...
  VendorSaveProfileRequest(
    ...
    if (idProofFile != null) {
      this._idProofFile = idProofFile;
    }
    if (addressProofFile != null) {
      this._addressProofFile = addressProofFile;
    }
    if (abountMe != null) {
  ...
  String? get idProofFile => _idProofFile;
  set idProofFile(String? idProofFile) => _idProofFile = idProofFile;
  String? get addressProofFile => _addressProofFile;
  set addressProofFile(String? addressProofFile) => _addressProofFile = addressProofFile;
  ...
  VendorSaveProfileRequest.fromJson(Map<String, dynamic> json) {
    ...
    _idProofFile = json['photo_id_proof'];
    _addressProofFile = json['address_proof'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['photo_id_proof'] = this._idProofFile;
    data['address_proof'] = this._addressProofFile;
