...
class _VendorProfileScreenState extends State<VendorProfileScreen> {
  ...
  void initState() {
    ...
    PluginGooglePlacePicker.initialize(iosApiKey: MyString.googleApiKey, androidApiKey: MyString.googleApiKey);
...
*/
                ...
                Text(
                  MyString.profile!,
                  style: const TextStyle(fontSize: MyDimens.textSize20, color: MyColor.themeBlue, fontFamily: 'roboto_bold'),
                ),
                const SizedBox(
                  height: 16,
                  width: 18,
            ...
            Padding(
              ...
              child: Text(
                MyString.setupYourProfile!,
                style: const TextStyle(fontSize: MyDimens.textSize18, color: MyColor.themeBlue, fontFamily: 'montserrat_medium'),
              ),
            ),
...
*/
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              MyString.submit!,
                              style: const TextStyle(fontSize: MyDimens.textSize15, color: Colors.white, fontFamily: 'sf_pro_bold'),
                            ),
                          )),
                    ),
                  ],
  ...
  Widget mobileField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        errorText: _getXController.isMobileEmpty
            ? "Please Enter mobile no"
            : _getXController.isMobileValid
  ...
  /// Dependency: google_places_picker: ^3.0.2
  /// call MyPlacePicker.showPlacePicker() by click on locationField()
  ...
  Widget locationField() {
    return TextFormField(
      ...
      onTap: () {
        setState(() async {
          _getXController.setAllErrorToFalse();
          Place place = await MyPlacePicker.showPlacePicker(); //open google place picker
  ...
  TextStyle fieldStyle() {
    return const TextStyle(fontSize: MyDimens.textSize14, color: MyColor.fieldGrey, fontFamily: 'sf_pro_regular');
  }

  ///*
  ///
  TextStyle labelStyle() {
    return const TextStyle(fontSize: MyDimens.textSize10, color: MyColor.labelGrey, fontFamily: 'sf_pro_semibold');
  }
  ...
  Widget mapLocationField() {
    return Row(
      children: [
        ...
        Text(
          MyString.selectYourLocation!,
          style: TextStyle(fontSize: MyDimens.textSize13, color: MyColor.textThemeBlue, fontFamily: 'montserrat_medium'),
        ),
      ],
    );
  }
    ...
    return DropdownSearch<countryListResponse.Payload?>(
      ...
      popupTitle: Row(
        ...
        children: const [
          Padding(
            ...
            child: Text("Select Country", style: TextStyle(fontSize: MyDimens.textSize16, color: MyColor.themeBlue, fontFamily: 'sf_pro_semibold')),
          ),
        ],
      ),
      showSearchBox: true,
      searchFieldProps: const TextFieldProps(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: TextStyle(fontSize: MyDimens.textSize14, color: MyColor.labelGrey, fontFamily: 'sf_pro_semibold'),
        ),
      ),
    ...
    return DropdownSearch<cityListResponse.Payload?>(
      ...
      popupTitle: Row(
        ...
        children: const [
          Padding(
            padding: EdgeInsets.only(top: 20.0),
            child: Text("Select City", style: TextStyle(fontSize: MyDimens.textSize16, color: MyColor.themeBlue, fontFamily: 'sf_pro_semibold')),
          ),
        ],
      ),
      showSearchBox: true,
  ...
  ///
  ///
  Widget _cityDropDownStyle(BuildContext context, cityListResponse.Payload? selectedData) {
    return Text(selectedData!.cityName!.toString(), style: fieldStyle());
  }

  ///*
  ///
  ///
  Widget _countryDropDownStyle(BuildContext context, countryListResponse.Payload? selectedData) {
    return Text(selectedData!.countryName!.toString(), style: fieldStyle());
  }
}
