                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                          onPressed: (){
                            ...
                            //by calling stripe_payment/ Api
                            //you will get below value
                            //stripeClientSecretKey = '';
                            //stripeCustomerId = '';
                            //stripeEphemeralKeySecret = '';
                            //paymentIntentId = '';
                            //after getting response of this api call makePayment() from this api call
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                          onPressed: (){
                            ...
                            // if isPaymentSucceeded is true then call save_order_details/ Api to book order
...
*/
  ...
  ///*
  /// use flutter_stripe: ^2.5.0 to make payment with stripe (updated flutter_stripe from 2.5.0 to 3.3.0 )
  /// call makePayment() after getting response by calling custom stripe_payment/ api using getXController.hitCreatePaymentIntentApi();
  /// stripe_payment/ api  return  below param in response which is use to initialize paymentSheet
  /// stripeClientSecretKey = '';
  //  stripeCustomerId = '';
  //  stripeEphemeralKeySecret = '';
  //  paymentIntentId = '';
  Future<void> makePayment() async {
    try {
      ...
      displayPaymentSheet(billingDetails);  //open payment sheet
  ...
  ///*
  ///
  ///  open payment sheet i.e stripe card
  displayPaymentSheet(BillingDetails billingDetails) async {
    try{
      ...
      if(paymentIntent.status == PaymentIntentsStatus.Succeeded){
        ...
        //update isPaymentSucceeded param to true once payment successfully done
        //so that user can do further steps
