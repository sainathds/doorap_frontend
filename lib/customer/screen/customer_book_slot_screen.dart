                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      /// - Test cases should be applied then only you are allow for selected time
                      ///     if vendor time showing 8 am to 18 Pm
                      ///     1. then below 8 am and after 18 pm time will not allow
                      ///     2. if customer try to select for current day and if current time is 11am and selected time is below 11 am then also not allow
                      ///     3. for selected service if vendor set time 1 hr and customer select time 11am that means slot will be booked from 11 am to 12 pm for that customer and
                      ///     4. if second customer try to select same time slot which is already booked for someone then also showing error
                      Container(
                            ...
                            child: Container(
                              ...
                              child: ElevatedButton(
                                  onPressed: (){
                                    ...
                                    }else if(!_getXController.isTimeInValid && !_getXController.isSelectPreviousTime){
                                      _getXController.isTimeEmpty = false;

                                      //if selected time is valid then redirect to checkout screen
                                      // from where you will do the stripe payment by adding card detail
