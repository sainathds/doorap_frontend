    ...
    return Column(
      children: [
            ...
            children: [
              ...
              InkWell(
                onTap: () async {
                  ...
                  //redirect to CustomerAllCategoryScreen() to see all category
        ...
        LayoutGrid(
          ...
          rowGap: 15,
          children: [
            if(_getXController.categoriesData.length <= 6)
            for (var index = 0; index < _getXController.categoriesData.length; index++)
              InkWell(
                onTap: () async {

                  //select category redirect to CustomerVendorsScreen()
                  //to see near by vendor for that category
