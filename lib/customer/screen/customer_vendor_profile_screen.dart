...
class _CustomerVendorProfileScreenState extends State<CustomerVendorProfileScreen> {
  ...
  void initState() {
    ...
    //get selected vendor profile data
      ...
      child: Scaffold(
        body: Column(
          children: [
            ...
            //by click on continue button redirect
      ...
      Container(
        ...
        child: ElevatedButton(
            onPressed: () async{
              ...
              //by click on continue button redirect to CustomerVendorServicesScreen
              // you will see vendor's services
