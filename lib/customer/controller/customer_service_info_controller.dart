...
class CustomerServiceInfoController extends GetxController{
  ...
  ///*
  ///
  /// get detail of selected service by calling
  /// show_vendor_facility/ Api
  ...
  ///*
  ///
  /// add to cart by calling item_add_to_cart/ Api
  void hitAddToCartApi() async{
    ...
    requestModel.categoryId = categoryId;
    requestModel.country = customerAddressModel.countryName;
    ...
    try{
      if(results != null){
        ...
        if(responseModel.status == 200){
          ...
          //redirect to CustomerCartSummaryScreen
