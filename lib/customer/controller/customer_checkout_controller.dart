...
class CustomerCheckoutController extends GetxController{
  ...
  ///*
  ///
  /// book order by calling save_order_details/ Api
  /// once order booked successfully you will redirect to CustomerOrderDetailsScreen
  void hitBookingOrderApi() async{
    ...
    try{
      if(results != null){
        ...
        if(responseModel.status == 200){
          hitCartCountApi(); //call this to get updated count of cart
