...
class SocialOtpVerificationController extends GetxController {

  String tag = "SocialOtpVerificationController";
  String callFrom = '';
  String enteredOtp = "";

  ///*
  /// check validations
  /// Otp received in api and entered Otp are same or not
  void isDataValid() {
    if (MySharedPreference.getString(MyConstants.keyResponseOtp) !=
      ...
      if (callFrom == "signup") {
        hitSignupApi(); //if OTP valid then registered user
      } else {
        navigateToCreateNewPass(); //navigate to CreateNewPassScreen
      }
    }
  }
  ...
  ///*
  ///
  /// Registered user using social_signup/ Api
