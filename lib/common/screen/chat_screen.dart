...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
   ...
   /* if(scrollController.hasClients){
    ...
    senderId = MySharedPreference.getInt(MyConstants.keyUserId);
    super.initState();
  }
  ...
  void sendMsg( int senderId, int receiverId,  String receiverName ,String message) {
    ...
    FirestoreChatModel firestoreChatModel = FirestoreChatModel(
        ...
        message: getEncryptedMsg(message),
        type: 'Text',
        isSeen: false);
  ...
  void sendNotification(String senderName, int senderId, int receiverId, String message) async{
    ...
    if(receiverUserModel.fcmToken != ''){
      ...
      // List<String> registrationIds = <String>['fvay_ADzROyxCByJHgdp27:APA91bE1kVmET1PmYObYLNtRl6MIFv65DdAeWvuyGN7FNwzR_vNz_xhggv0Z2oaPTKu2lF6YmuoXfOYtANaWTyLhPHz60BfOJzyOh7CIW8vh0z-HSeUgTjixiAx2IID9NuRRWl1eE0Me'];
