...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    ...
    MySharedPreference.getInstance(); //get instance of sharedPreference
    handleSession();
    super.initState();
  }
  ...
  /// if login then check isVendor or customer else redirect to welcome screen
  /// if vendor then check is profile completed if yes then redirect to VendorHomeScreen
  /// if customer then redirect to CustomerBtmScreen
  void handleSession() {
