...
class _RecentChatListScreenState extends State<RecentChatListScreen> {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            getDecryptedMsg(documentSnapshot.get(
  ...
  ///*
  ///
  /// get users list that you have recently chat
  getRecentChatList() {
  ...
  ///*
  ///
  /// get Last message of users that you have Recently chat
  ...
  ///*
  ///
  /// update chat Data in "RecentChat" collection
