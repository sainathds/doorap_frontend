...
/// New URL's
const baseUrl = "https://admin.doorap.com/";
const vendorBaseUrl = "https://admin.doorap.com/api/";
const customerBaseUrl = "https://admin.doorap.com/customer/";
...
const deleteCustomerVendorApi = vendorBaseUrl + "Delete_Customer_Vendor/";  //use for both vendor and customer
